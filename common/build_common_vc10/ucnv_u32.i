# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c"
# 17 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c"
...
# 18 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c" 2
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c" 2
...
ucnv_swap_48(const UDataSwapper *ds,
          const void *inData, int32_t length, void *outData,
          UErrorCode *pErrorCode);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c" 2
# 37 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c"
enum {
...
morebytes:
        ...
        if (ch <= 0x0010FFFF && !(((ch)&0xfffff800)==0xd800)) {
            ...
            if (ch <= 0x0000FFFF)
            {
                ...
                *(myTarget++) = (UChar)(((ch)>>10)+0xd7c0);
                ch = (UChar)(((ch)&0x3ff)|0xdc00);
                                  ...
                                  UErrorCode * err)
{
    ...
    if(args->converter->fromUnicodeStatus==UCNV_NEED_TO_WRITE_BOM) {
        ...
        ucnv_fromUWriteBytes_48(args->converter,
                             bom, 4,
                                   ...
                                   UErrorCode* err)
{
    ...
    if ((uint32_t)myUChar <= 0x0010FFFF && !(((myUChar)&0xfffff800)==0xd800)) {
        return myUChar;
    }
...
const UConverterSharedData _UTF32BEData_48 = {
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF32BEStaticData, 0, &_UTF32BEImpl,
    0
};
...
const UConverterSharedData _UTF32LEData_48 = {
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF32LEStaticData, 0, &_UTF32LEImpl,
    0
};
# 1022 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u32.c"
static void
...
const UConverterSharedData _UTF32Data_48 = {
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF32StaticData, 0, &_UTF32Impl,
    0
};
