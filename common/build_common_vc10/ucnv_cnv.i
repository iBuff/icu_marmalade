# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c"
# 18 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c"
...
# 19 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
...
extern void UCNV_TO_U_CALLBACK_ESCAPE_48 (
                  ...
                  UConverterCallbackReason reason,
                  UErrorCode * err);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
...
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
...
ucnv_toUWriteCodePoint_48(UConverter *cnv,
                       ...
                       int32_t sourceIndex,
                       UErrorCode *pErrorCode);
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_bld.h" 1
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_bld.h"
...
ucnv_swap_48(const UDataSwapper *ds,
          const void *inData, int32_t length, void *outData,
          UErrorCode *pErrorCode);
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.c" 2
...
ucnv_fromUWriteBytes_48(UConverter *cnv,
    ...
    if(offsets==((void *)0) || (o=*offsets)==((void *)0)) {
...
ucnv_toUWriteCodePoint_48(UConverter *cnv,
    ...
    *target=t;
    ...
    if(c>=0) {
        if(cnv!=((void *)0)) {
            int8_t i=0;
            { if((uint32_t)(c)<=0xffff) { (cnv->UCharErrorBuffer)[(i)++]=(uint16_t)(c); } else { (cnv->UCharErrorBuffer)[(i)++]=(uint16_t)(((c)>>10)+0xd7c0); (cnv->UCharErrorBuffer)[(i)++]=(uint16_t)(((c)&0x3ff)|0xdc00); } };
