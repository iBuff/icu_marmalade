# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c"
# 18 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c"
...
# 19 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c" 2
...
extern void UCNV_TO_U_CALLBACK_ESCAPE_48 (
                  ...
                  UConverterCallbackReason reason,
                  UErrorCode * err);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c" 2
...
extern void ucnv_cbToUWriteSub_48 (UConverterToUnicodeArgs *args,
                       int32_t offsetIndex,
                       UErrorCode * err);
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.h" 1
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.h"
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/ucnv.h" 1
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cnv.h" 2
...
ucnv_toUWriteCodePoint_48(UConverter *cnv,
                       ...
                       int32_t sourceIndex,
                       UErrorCode *pErrorCode);
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c" 2
...
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c" 2

# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrfmt.h" 1
# 13 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ustrfmt.h"
extern int32_t
uprv_itou_48 (UChar * buffer, int32_t capacity, uint32_t i, uint32_t radix, int32_t minwidth);
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c" 2
# 54 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_err.c"
extern void
                  ...
                  UErrorCode * err)
{
    if (reason <= UCNV_IRREGULAR)
    {
        ...
        {
            *err = U_ZERO_ERROR;
            ucnv_cbFromUWriteSub_48(fromArgs, 0, err);
        }
                         ...
                         UErrorCode * err)
{
  ...
  UChar valueString[32];
  int32_t valueStringLength = 0;
  int32_t i = 0;

  const UChar *myValueSource = ((void *)0);
  UErrorCode err2 = U_ZERO_ERROR;
  UConverterFromUCallback original = ((void *)0);
  const void *originalContext;

  UConverterFromUCallback ignoredCallback = ((void *)0);
  ...
  ucnv_setFromUCallBack_48 (fromArgs->converter,
                     (UConverterFromUCallback) UCNV_FROM_U_CALLBACK_SUBSTITUTE_48,
                     ((void *)0),
                     &original,
                     &originalContext,
                     &err2);

  if (((err2)>U_ZERO_ERROR))
  {
    *err = err2;
    return;
  }
  if(context==((void *)0))
  {
      while (i < length)
      {
        valueString[valueStringLength++] = (UChar) 0x0025;
        valueString[valueStringLength++] = (UChar) 0x0055;
        valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, (uint16_t)codeUnits[i++], 16, 4);
      }
  }
  else
  {
      ...
      case 'J':
          while (i < length)
          {
              valueString[valueStringLength++] = (UChar) 0x005C;
              valueString[valueStringLength++] = (UChar) 0x0075;
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, (uint16_t)codeUnits[i++], 16, 4);
          }
          break;
      ...
      case 'C':
          ...
          if(length==2){
              valueString[valueStringLength++] = (UChar) 0x0055;
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, codePoint, 16, 8);

          }
          else{
              valueString[valueStringLength++] = (UChar) 0x0075;
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, (uint16_t)codeUnits[0], 16, 4);
          }
          break;

      case 'D':

          valueString[valueStringLength++] = (UChar) 0x0026;
          valueString[valueStringLength++] = (UChar) 0x0023;
          if(length==2){
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, codePoint, 10, 0);
          }
          else{
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, (uint16_t)codeUnits[0], 10, 0);
          }
          valueString[valueStringLength++] = (UChar) 0x003B;
          break;
      ...
      case 'X':
          ...
          valueString[valueStringLength++] = (UChar) 0x0026;
          valueString[valueStringLength++] = (UChar) 0x0023;
          valueString[valueStringLength++] = (UChar) 0x0078;
          if(length==2){
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, codePoint, 16, 0);
          }
          else{
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, (uint16_t)codeUnits[0], 16, 0);
          }
          valueString[valueStringLength++] = (UChar) 0x003B;
          break;

      case 'U':
          valueString[valueStringLength++] = (UChar) 0x007B;
          valueString[valueStringLength++] = (UChar) 0x0055;
          valueString[valueStringLength++] = (UChar) 0x002B;
          if (length == 2) {
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, codePoint, 16, 4);
          } else {
              valueStringLength += uprv_itou_48 (valueString + valueStringLength, 32 - valueStringLength, (uint16_t)codeUnits[0], 16, 4);
          }
          valueString[valueStringLength++] = (UChar) 0x007D;
          break;
      ...
      case 'S':
          ...
          valueString[valueStringLength++] = (UChar) 0x0020;
          break;
  ...
  *err = U_ZERO_ERROR;
  ...
  ucnv_cbFromUWriteUChars_48(fromArgs, &myValueSource, myValueSource+valueStringLength, 0, err);
                 ...
                 UErrorCode * err)
{
    if (reason <= UCNV_IRREGULAR)
    {
        ...
        {
            *err = U_ZERO_ERROR;
            ucnv_cbToUWriteSub_48(toArgs,0,err);
        }
                 ...
                 UErrorCode * err)
{
    ...
    if(context==((void *)0))
    {
        while (i < length)
        {
            uniValueString[valueStringLength++] = (UChar) 0x0025;
            uniValueString[valueStringLength++] = (UChar) 0x0058;
            valueStringLength += uprv_itou_48 (uniValueString + valueStringLength, 32 - valueStringLength, (uint8_t) codeUnits[i++], 16, 2);
        }
    }
    else
    {
        ...
        case 'D':
            while (i < length)
            {
                uniValueString[valueStringLength++] = (UChar) 0x0026;
                uniValueString[valueStringLength++] = (UChar) 0x0023;
                valueStringLength += uprv_itou_48 (uniValueString + valueStringLength, 32 - valueStringLength, (uint8_t)codeUnits[i++], 10, 0);
                uniValueString[valueStringLength++] = (UChar) 0x003B;
            }
            break;
        ...
        case 'X':
            while (i < length)
            {
                uniValueString[valueStringLength++] = (UChar) 0x0026;
                uniValueString[valueStringLength++] = (UChar) 0x0023;
                uniValueString[valueStringLength++] = (UChar) 0x0078;
                valueStringLength += uprv_itou_48 (uniValueString + valueStringLength, 32 - valueStringLength, (uint8_t)codeUnits[i++], 16, 0);
                uniValueString[valueStringLength++] = (UChar) 0x003B;
            }
            break;
        case 'C':
            while (i < length)
            {
                uniValueString[valueStringLength++] = (UChar) 0x005C;
                uniValueString[valueStringLength++] = (UChar) 0x0078;
                valueStringLength += uprv_itou_48 (uniValueString + valueStringLength, 32 - valueStringLength, (uint8_t)codeUnits[i++], 16, 2);
            }
            break;
        default:
            while (i < length)
            {
                uniValueString[valueStringLength++] = (UChar) 0x0025;
                uniValueString[valueStringLength++] = (UChar) 0x0058;
                uprv_itou_48 (uniValueString + valueStringLength, 32 - valueStringLength, (uint8_t) codeUnits[i++], 16, 2);
                valueStringLength += 2;
            }
        }
    }
    ...
    *err = U_ZERO_ERROR;
    ...
    ucnv_cbToUWriteUChars_48(toArgs, uniValueString, valueStringLength, 0, err);
}
