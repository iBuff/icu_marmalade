# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c"
# 20 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c"
...
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c" 2
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c" 2
...
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c" 2

# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.h" 1
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.h"
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c" 2

extern void UDataMemory_init_48(UDataMemory *This) {
    memset(This, 0, sizeof(UDataMemory));
    This->length=-1;
}
...
extern UDataMemory *UDataMemory_createNewInstance_48(UErrorCode *pErr) {
    ...
    if (((*pErr)>U_ZERO_ERROR)) {
        return ((void *)0);
    }
    This = uprv_malloc_48(sizeof(UDataMemory));
    if (This == ((void *)0)) {
        *pErr = U_MEMORY_ALLOCATION_ERROR; }
    else {
        UDataMemory_init_48(This);
        This->heapAllocated = 1;
    }
    return This;
}


extern const DataHeader *
UDataMemory_normalizeDataPointer_48(const void *p) {

    const DataHeader *pdh = (const DataHeader *)p;
    if(pdh==((void *)0) || (pdh->dataHeader.magic1==0xda && pdh->dataHeader.magic2==0x27)) {
        return pdh;
    } else {
# 78 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c"
...
extern void UDataMemory_setData_48 (UDataMemory *This, const void *dataAddr) {
    This->pHeader = UDataMemory_normalizeDataPointer_48(dataAddr);
}
...
extern const void *
udata_getMemory_48(UDataMemory *pData) {
    if(pData!=((void *)0) && pData->pHeader!=((void *)0)) {
        return (char *)(pData->pHeader)+udata_getHeaderSize_48(pData->pHeader);
    } else {
        return ((void *)0);
    }
}
# 130 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/udatamem.c"
extern int32_t
udata_getLength_48(const UDataMemory *pData) {
    if(pData!=((void *)0) && pData->pHeader!=((void *)0) && pData->length>=0) {




        return pData->length-udata_getHeaderSize_48(pData->pHeader);
    } else {
        return -1;
    }
}
