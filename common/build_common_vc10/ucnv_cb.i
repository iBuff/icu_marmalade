# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c"
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c"
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c" 2
...
extern void ucnv_cbToUWriteSub_48 (UConverterToUnicodeArgs *args,
                       int32_t offsetIndex,
                       UErrorCode * err);
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c" 2
...
ucnv_swap_48(const UDataSwapper *ds,
          const void *inData, int32_t length, void *outData,
          UErrorCode *pErrorCode);
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c" 2
...
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c" 2
...
extern void
ucnv_cbFromUWriteUChars_48(UConverterFromUnicodeArgs *args,
                             const UChar** source,
                             const UChar* sourceLimit,
                             int32_t offsetIndex,
                             UErrorCode * err)
{
# 72 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c"
    char *oldTarget;
    ...
    ucnv_fromUnicode_48(args->converter,
        &args->target,
        args->targetLimit,
        source,
        sourceLimit,
...
# 171 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c"
    }
}
                           ...
                           UErrorCode * err)
{
    ...
    if(length < 0) {
# 201 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_cb.c"
        const UChar *source = (const UChar *)converter->subChars;
        ucnv_cbFromUWriteUChars_48(args, &source, source - length, offsetIndex, err);
        return;
    }

    if(converter->sharedData->impl->writeSub!=((void *)0)) {
...
extern void
ucnv_cbToUWriteUChars_48 (UConverterToUnicodeArgs *args,
                            const UChar* source,
                            int32_t length,
                            int32_t offsetIndex,
                            UErrorCode * err)
...
extern void
ucnv_cbToUWriteSub_48 (UConverterToUnicodeArgs *args,
                         int32_t offsetIndex,
                       UErrorCode * err)
{
    ...
    if(args->converter->invalidCharLength == 1 && args->converter->subChar1 != 0) {
        ucnv_cbToUWriteUChars_48(args, &kSubstituteChar1, 1, offsetIndex, err);
    } else {
        ucnv_cbToUWriteUChars_48(args, &kSubstituteChar, 1, offsetIndex, err);
    }
}
