# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
...
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c" 2
...
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c" 2
...
extern void ucnv_cbToUWriteSub_48 (UConverterToUnicodeArgs *args,
                       int32_t offsetIndex,
                       UErrorCode * err);
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c" 2
...
ucnv_swap_48(const UDataSwapper *ds,
          const void *inData, int32_t length, void *outData,
          UErrorCode *pErrorCode);
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c" 2
...
# 31 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c" 2
...
# 141 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
    uint8_t locale;
...
_SCSUOpen(UConverter *cnv,
    ...
    cnv->extraInfo=uprv_malloc_48(sizeof(SCSUData));
    if(cnv->extraInfo!=((void *)0)) {
        if(locale!=((void *)0) && locale[0]=='j' && locale[1]=='a' && (locale[2]==0 || locale[2]=='_')) {
...
_SCSUToUnicodeWithOffsets(UConverterToUnicodeArgs *pArgs,
    ...
    nextSourceIndex=0;
# 285 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
    if(isSingleByteMode) {
...
endloop:
    ...
    if(((*pErrorCode)>U_ZERO_ERROR) && *pErrorCode!=U_BUFFER_OVERFLOW_ERROR) {
...
# 582 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
static void
_SCSUToUnicode(UConverterToUnicodeArgs *pArgs,
    ...
    dynamicWindow=scsu->toUDynamicWindow;
    byteOne=scsu->toUByteOne;
# 631 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
    if(isSingleByteMode) {
...
# 881 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
static int8_t
...
# 960 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
static int
...
# 1007 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
static void
...
outputBytes:
    ...
    if(length<=targetCapacity) {
        ...
        uint8_t *p;
# 1444 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
...
# 1500 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
static void
...
outputBytes:
    ...
    if(length<=targetCapacity) {
        ...
        uint8_t *p;
# 1881 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnvscsu.c"
        length-=targetCapacity;
        p=(uint8_t *)cnv->charErrorBuffer;
        switch(length) {
...
const UConverterSharedData _SCSUData_48={
    sizeof(UConverterSharedData), ~((uint32_t)0),
    ((void *)0), ((void *)0), &_SCSUStaticData, 0, &_SCSUImpl,
    0
};
