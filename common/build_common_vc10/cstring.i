# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c"
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c"
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c" 2
...
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c" 2
...
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c" 2
...
# 29 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/uassert.h" 1
# 30 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c" 2
# 49 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c"
extern char
uprv_toupper_48(char c) {
...
# 89 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c"
extern char
uprv_asciitolower_48(char c) {
    if(0x41<=c && c<=0x5a) {
        c=(char)(c+0x20);
...
T_CString_toLowerCase_48(char* str)
{
    ...
    if (str) {
        do
            *str = (char)uprv_asciitolower_48(*str);
        while (*(str++));
    }
...
extern int32_t
T_CString_integerToString_48(char* buffer, int32_t v, int32_t radix)
{
    char tbuf[30];
    ...
    do {
        ...
        tbuf[--tbx] = (char)(((digit)<=9?('0'+(digit)):('A'+(digit)-10)));
        uval = uval / radix;
    } while (uval != 0);
...
# 181 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cstring.c"
extern int32_t
T_CString_int64ToString_48(char* buffer, int64_t v, uint32_t radix)
{
    char tbuf[30];
    int32_t tbx = sizeof(tbuf);
    uint8_t digit;
    ...
    if(str1==((void *)0)) {
        ...
        for(;;) {
            ...
            if(c1==0) {
                ...
                rc=(int)(unsigned char)uprv_asciitolower_48(c1)-(int)(unsigned char)uprv_asciitolower_48(c2);
                if(rc!=0) {
                    return rc;
                }
            }
...
uprv_strdup_48(const char *src) {
    ...
    char *dup = (char *) uprv_malloc_48(len);
...
uprv_strndup_48(const char *src, int32_t n) {
    ...
    if(n < 0) {
        dup = uprv_strdup_48(src);
    } else {
        dup = (char*)uprv_malloc_48(n+1);
        if (dup) {
            memcpy(dup, src, n);
            dup[n] = 0;
        }
