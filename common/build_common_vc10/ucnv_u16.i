# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c"
# 17 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c"
...
# 18 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c" 2
...
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c" 2
...
ucnv_swap_48(const UDataSwapper *ds,
          const void *inData, int32_t length, void *outData,
          UErrorCode *pErrorCode);
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c" 2
...
_UTF16ToUnicodeWithOffsets(UConverterToUnicodeArgs *pArgs,
                           UErrorCode *pErrorCode);
# 47 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c"
static void
_UTF16BEFromUnicodeWithOffsets(UConverterFromUnicodeArgs *pArgs,
    ...
    if((c=(UChar)cnv->fromUChar32)!=0 && (((trail=*source)&0xfffffc00)==0xdc00) && targetCapacity>=4) {
        ...
        if(offsets==((void *)0)) {
            while(count>0) {
                ...
                if(!(((c)&0xfffff800)==0xd800)) {
                    ...
                    target[1]=(uint8_t)c;
                    target+=2;
                } else if((((c)&0x400)==0) && count>=2 && (((trail=*source)&0xfffffc00)==0xdc00)) {
                    ++source;
                    --count;
                    target[0]=(uint8_t)(c>>8);
                    target[1]=(uint8_t)c;
    ...
    if(c!=0) {
        ...
        if((((c)&0x400)==0)) {
            if(source<pArgs->sourceLimit) {
                if((((trail=*source)&0xfffffc00)==0xdc00)) {
    ...
    if(((*pErrorCode)<=U_ZERO_ERROR) && source<pArgs->sourceLimit && targetCapacity==0) {
        *pErrorCode=U_BUFFER_OVERFLOW_ERROR;
    }
...
_UTF16BEToUnicodeWithOffsets(UConverterToUnicodeArgs *pArgs,
    ...
    if(c==0 && count>0) {
        ...
        if(offsets==((void *)0)) {
            do {
                ...
                if(!(((c)&0xfffff800)==0xd800)) {
                    *target++=c;
                } else if((((c)&0x400)==0) && count>=2 &&
                          (((trail=((UChar)source[0]<<8)|source[1])&0xfffffc00)==0xdc00)
                ) {
                    source+=2;
                    --count;
                    *target++=c;
    ...
    if(c!=0) {
        ...
        if((((c)&0x400)==0)) {
            if(length>=2) {
                if((((trail=((UChar)source[0]<<8)|source[1])&0xfffffc00)==0xdc00)) {
    ...
    if((((c)&0xfffff800)==0xd800)) {
        if((((c)&0x400)==0)) {
            if(s+2<=sourceLimit) {
                ...
                trail=((UChar)*s<<8)|s[1];
                if((((trail)&0xfffffc00)==0xdc00)) {
                    c=(((UChar32)(c)<<10UL)+(UChar32)(trail)-((0xd800<<10UL)+0xdc00-0x10000));
                    s+=2;
                } else {
...
_UTF16BEReset(UConverter *cnv, UConverterResetChoice choice) {
    if(choice<=UCNV_RESET_TO_UNICODE) {
        ...
        if(((cnv)->options&0xf)==0) {
            cnv->mode=8;
        } else {
            cnv->mode=0;
        }
    }
    if(choice!=UCNV_RESET_TO_UNICODE && ((cnv)->options&0xf)==1) {
...
const UConverterSharedData _UTF16BEData_48={
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF16BEStaticData, 0, &_UTF16BEImpl,
    0
};
...
_UTF16LEToUnicodeWithOffsets(UConverterToUnicodeArgs *pArgs,
            ...
            do {
                ...
                if(!(((c)&0xfffff800)==0xd800)) {
                    *target++=c;
                          ...
                          (((trail=((UChar)source[1]<<8)|source[0])&0xfffffc00)==0xdc00)
                ) {
                    source+=2;
                    --count;
                    *target++=c;
    ...
    if(c!=0) {
        ...
        if((((c)&0x400)==0)) {
            if(length>=2) {
                if((((trail=((UChar)source[1]<<8)|source[0])&0xfffffc00)==0xdc00)) {
...
const UConverterSharedData _UTF16LEData_48={
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF16LEStaticData, 0, &_UTF16LEImpl,
    0
};
# 1270 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_u16.c"
static void
...
_UTF16Open(UConverter *cnv,
           UConverterLoadArgs *pArgs,
           UErrorCode *pErrorCode) {
    if(((cnv)->options&0xf)<=2) {
        if(((cnv)->options&0xf)==2 && !pArgs->onlyTestIsLoadable) {
            ...
            memcpy(cnv->subChars, _UTF16v2Data.staticData->subChar, 4);
        }
...
const UConverterSharedData _UTF16Data_48;
...
_UTF16ToUnicodeWithOffsets(UConverterToUnicodeArgs *pArgs,
    ...
    while(source<sourceLimit && ((*pErrorCode)<=U_ZERO_ERROR)) {
        switch(state) {
        case 0:
        ...
        case 1:
            ...
            if(cnv->toUBytes[0]==0xfe && b==0xff) {
                if(((cnv)->sharedData==&_UTF16LEData_48)) {
                    state=7;
                } else {
                    state=8;
                }
            } else if(cnv->toUBytes[0]==0xff && b==0xfe) {
                if(((cnv)->sharedData==&_UTF16BEData_48)) {
                    state=6;
                } else {
                    state=9;
                }
            } else if((((cnv)->sharedData==&_UTF16Data_48 || (cnv)->sharedData==&_UTF16v2Data) && ((cnv)->options&0xf)==1)) {
                state=6;
            }
            if(state>=8) {
    ...
    if(offsets!=((void *)0) && offsetDelta!=0) {
...
const UConverterSharedData _UTF16Data_48 = {
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF16StaticData, 0, &_UTF16Impl,
    0
};
...
static const UConverterSharedData _UTF16v2Data = {
    sizeof(UConverterSharedData), ~((uint32_t) 0),
    ((void *)0), ((void *)0), &_UTF16v2StaticData, 0, &_UTF16v2Impl,
    0
};
