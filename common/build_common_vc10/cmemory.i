# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c"
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c"
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/uclean.h" 1
# 20 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/uclean.h"
...
# 21 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/unicode/uclean.h" 2
...
u_setMemoryFunctions_48(const void *context, UMemAllocFn *a, UMemReallocFn *r, UMemFreeFn *f,
                    UErrorCode *status);
# 22 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c" 2
...
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c" 2
...
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c" 2
...
extern void *
uprv_realloc_48(void * buffer, size_t size) {
    if (buffer == zeroMem) {
        return uprv_malloc_48(size);
    } else if (size == 0) {
        if (pFree) {
...
extern void
u_setMemoryFunctions_48(const void *context, UMemAllocFn *a, UMemReallocFn *r, UMemFreeFn *f, UErrorCode *status)
{
    if (((*status)>U_ZERO_ERROR)) {
        return;
    }
    if (a==((void *)0) || r==((void *)0) || f==((void *)0)) {
...
extern UBool cmemory_cleanup_48(void) {
    pContext = ((void *)0);
    pAlloc = ((void *)0);
    pRealloc = ((void *)0);
    pFree = ((void *)0);
...
# 122 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/cmemory.c"
extern UBool cmemory_inUse_48() {
    return gHeapInUse;
}
