 ...
 # options passed:  -fpreprocessed ucnv_set.i -mel -mno-jals -mips1
 # -mabi=32 -mhard-float -mllsc -auxbase-strip
 # Debug_common_vc10_gcc_mips//ucnv_set.obj -g -O0 -Wall -Wno-unused
...
$Ltext0:
 # Compiler executable checksum: 9ed99d423a551df6ee1ed3d8638bd57e
	...
	.align	2
	.globl	ucnv_getUnicodeSet_48
	.hidden	ucnv_getUnicodeSet_48
$LFB0 = .
	.file 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucnv_set.c"
	.loc 1 33 0
	.set	nomips16
	.set	nomicromips
	.ent	ucnv_getUnicodeSet_48
	.type	ucnv_getUnicodeSet_48, @function
ucnv_getUnicodeSet_48:
...
$LCFI3:
	.cprestore	16	 #
	sw	$4,56($fp)	 # cnv, cnv
	sw	$5,60($fp)	 # setFillIn, setFillIn
	sw	$6,64($fp)	 # whichSet, whichSet
...
$L3:
	.loc 1 38 0
	lw	$2,56($fp)	 # tmp202, cnv
	nop
	beq	$2,$0,$L5
	nop
	 #, tmp202,,
	lw	$2,60($fp)	 # tmp203, setFillIn
	nop
	beq	$2,$0,$L5
	nop
	 #, tmp203,,
	lw	$2,64($fp)	 # tmp204, whichSet
	nop
	sltu	$2,$2,2	 # tmp205, tmp204,
	bne	$2,$0,$L6
	nop
	 #, tmp205,,
$L5:
...
$L6:
	.loc 1 44 0
	lw	$2,56($fp)	 # tmp208, cnv
	nop
	lw	$2,24($2)	 # D.3534, <variable>.sharedData
	nop
	lw	$2,24($2)	 # D.3535, <variable>.impl
	nop
	lw	$2,60($2)	 # D.3536, <variable>.getUnicodeSet
	nop
	bne	$2,$0,$L7
	nop
	 #, D.3536,,
	.loc 1 45 0
	lw	$2,68($fp)	 # tmp209, pErrorCode
	li	$3,16			# 0x10	 # tmp210,
	sw	$3,0($2)	 # tmp210,
	.loc 1 46 0
	b	$L8
...
$LBB2 = .
	.loc 1 57 0
	sw	$0,24($fp)	 #, sa.set
	lw	$2,%got(uset_add_48)($28)	 # tmp211,,
	nop
	sw	$2,28($fp)	 # tmp211, sa.add
	lw	$2,%got(uset_addRange_48)($28)	 # tmp212,,
	nop
	sw	$2,32($fp)	 # tmp212, sa.addRange
	lw	$2,%got(uset_addString_48)($28)	 # tmp213,,
	nop
	sw	$2,36($fp)	 # tmp213, sa.addString
	lw	$2,%got(uset_remove_48)($28)	 # tmp214,,
	nop
	sw	$2,40($fp)	 # tmp214, sa.remove
	lw	$2,%got(uset_removeRange_48)($28)	 # tmp215,,
	nop
	sw	$2,44($fp)	 # tmp215, sa.removeRange
	.loc 1 58 0
	lw	$2,60($fp)	 # tmp216, setFillIn
	nop
	sw	$2,24($fp)	 # tmp216, sa.set
	.loc 1 61 0
	lw	$4,60($fp)	 #, setFillIn
	lw	$2,%call16(uset_clear_48)($28)	 # tmp217,,
	nop
	move	$25,$2	 #, tmp217
	jalr	$25
	nop
	...
	lw	$28,16($fp)	 #,
	.loc 1 64 0
	lw	$2,56($fp)	 # tmp218, cnv
	nop
	lw	$2,24($2)	 # D.3539, <variable>.sharedData
	nop
	lw	$2,24($2)	 # D.3540, <variable>.impl
	nop
	lw	$2,60($2)	 # D.3541, <variable>.getUnicodeSet
	lw	$4,56($fp)	 #, cnv
	addiu	$3,$fp,24	 # tmp219,,
	move	$5,$3	 #, tmp219
	lw	$6,64($fp)	 #, whichSet
...
$L8:
	...
	.set	macro
	.set	reorder
	.end	ucnv_getUnicodeSet_48
$LFE0:
	.size	ucnv_getUnicodeSet_48, .-ucnv_getUnicodeSet_48
...
$LLST0:
	...
	.4byte	0x14dc
	.4byte	0x1476
	.ascii	"ucnv_getUnicodeSet_48\000"
	.4byte	0x0
