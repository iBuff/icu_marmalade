# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
...
# 1 "<command-line>" 2
# 1 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
# 23 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
...
# 24 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c" 2
...
# 25 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c" 2
...
# 26 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c" 2
...
# 27 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c" 2
...
# 28 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c" 2
...
# 69 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
typedef struct {
...
# 98 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
static int32_t
...
offsetTOCPrefixBinarySearch(const char *s, const char *names,
    ...
    while(start<limit) {
        ...
        int32_t prefixLength=(((startPrefixLength)<(limitPrefixLength)) ? (startPrefixLength) : (limitPrefixLength));
...
# 234 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
...
static uint32_t pointerTOCEntryCount(const UDataMemory *pData) {
    ...
    return (uint32_t)((toc != ((void *)0)) ? (toc->count) : 0);
}
...
static const DataHeader *pointerTOCLookupFn(const UDataMemory *pData,
    ...
    if(pData->toc!=((void *)0)) {
        ...
        if(number>=0) {
            ...
            *pLength=-1;
            return UDataMemory_normalizeDataPointer_48(toc->entry[number].pHeader);
        } else {
...
# 315 "c:/users/will/documents/utterspeech/marmalade/icu/common/source/ucmndata.c"
extern void udata_checkCommonData_48(UDataMemory *udm, UErrorCode *err) {
    if (((*err)>U_ZERO_ERROR)) {
        return;
    }

    if(udm==((void *)0) || udm->pHeader==((void *)0)) {
      *err=U_INVALID_FORMAT_ERROR;
        ...
        *err=U_INVALID_FORMAT_ERROR;
        ...
        udm->toc=(const char *)udm->pHeader+udata_getHeaderSize_48(udm->pHeader);
    }
